...
contract Storage {
     // Shared storage
    uint8 constant public MAX_OWNER_COMPANIES = 5; // 1 owner could register up to 5 companies.
    uint8 constant public MAX_COMPANY_TOKENS = 10; // 1 company could register up to 10 tokens.
